...
var config = ({
  ...
  // 这句话的意思是，这个配置是与平台有关的，很可能会被覆盖掉 .查看\src\platforms\web\runtime\index.js中可以看到这些值被覆盖了
  /**
...
function initGlobalAPI (Vue) {
  // config
  // 这段代码的作用是在 Vue 构造函数上添加 config 属性;可以通过console.log(Vue.config)查看
  var configDef = {};
  ...
  //最终得到的vue.options可以通过console.log(vue.options)查看
